RSpec.describe 'luokka Varipiste' do
  ...
  it "metodi etaisyys_origosta toimii" do
    ...
    expect(p1.etaisyys_origosta).to eq(5)

    p1 = Varipiste.new 1, 1, :vihrea
    expect(p1.etaisyys_origosta).to eq(Math.sqrt(2))
  end
...
RSpec.describe 'luokka Piste3d' do
  ...
  it "metodi etaisyys_origosta toimii" do
    ...
    expect(p1.etaisyys_origosta).to eq(6)

    p1 = Piste3d.new 1, 1, 1
    expect(p1.etaisyys_origosta).to eq(Math.sqrt(3))
  end
